...
const addProductStoneDetailsController = async (req, res) => {
    const { subproductname, weight, ratepergram, amount, totalweight, totalprice } = req.body;
    ...
    try {
      const result = await stoneDetailsModel.addProductStoneDetails(subproductname, weight, ratepergram, amount, totalweight, totalprice);
...
const updateStoneDetail = (req, res) => {
    ...
    const { subproductname, weight, amount, ratepergram, totalweight, totalprice } = req.body;

    const data = [subproductname, weight, amount, ratepergram, totalweight, totalprice];
