...
const addCompany = (companyData, callback) => {
  ...
  db.query(query, [
    ...
    companyData.pincode, companyData.state, companyData.state_code, companyData.country,
...
const updateCompanyById = (companyData, id, callback) => {
  ...
  db.query(query, [
    ...
    companyData.state, companyData.state_code, companyData.country, companyData.mobile, companyData.phone, 
