  ...
  insertPurchase: (mergedValues, callback) => {
    const sql = `
      INSERT INTO purchase (
        ...
        terms, indent, bill_no, type, rate_cut, date, bill_date, due_date, Purchase_rate, 
        code, product_id, product_name, metal_type, design_name, purity, hsn, product_type, stock_type, pcs, gross_weight, stone_weight, net_weight,
