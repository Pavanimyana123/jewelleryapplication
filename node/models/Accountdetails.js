...
const insertAccountDetails = (data, callback) => {
    ...
    db.query(sql, [
        ...
        data.phone, data.mobile, data.contact_person, data.email, data.birthday, data.anniversary, 
        data.bank_account_no, data.bank_name, data.ifsc_code, data.branch, 
        data.gst_in, data.aadhar_card, data.pan_card
    ], callback);
};
...
const updateAccountDetails = (account_id, data, callback) => {
    ...
    db.query(sql, [
        ...
        data.phone, data.mobile, data.contact_person, data.email, data.birthday, data.anniversary, 
        data.bank_account_no, data.bank_name, data.ifsc_code, data.branch, 
        data.gst_in, data.aadhar_card, data.pan_card, account_id
    ], callback);
};
